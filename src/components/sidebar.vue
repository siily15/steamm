<template>
  <img src="https://steamstore-a.akamaihd.net/public/images//gift/steamcards_promo_02.png" alt="Steam gift cards"/>
    <div class="text-gray-200 flex flex-col text-left ml-24 mt-1 text-sm">KINKEKAARDID
        <a href="#" class="text-blue-500 hover:text-white" >Nüüd on olemas</a>
    </div>
    <div class="text-gray-200 flex flex-col text-left ml-24 mt-1 text-sm">SOOVITUSED
    ...
    <div class="text-gray-200 flex flex-col text-left ml-24 mt-1 text-sm">AVASTAMISE JÄRJEKORD
        <a href="#" class="text-blue-500 hover:text-white">Soovitused</a>
        <a href="#" class="text-blue-500 hover:text-white">uued väljaanded</a>
    </div>
    <div class="text-gray-200 flex flex-col text-left ml-24 mt-1 text-sm">KATEGOORIAD
    ...
    <div class="text-gray-200 flex flex-col text-left ml-24 mt-1 text-sm">ŽANRID
        ...
        <a href="#" class="text-blue-500 hover:text-white">Massiivselt mitmikmäng</a>
